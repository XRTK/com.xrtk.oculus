...
namespace XRTK.Oculus.Controllers
{
    public class OculusTouchController : BaseOculusController
    {
        ...
        public override MixedRealityInteractionMapping[] DefaultLeftHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(6, "Axis1D.PrimaryHandTrigger Press", AxisType.Digital, DeviceInputType.Trigger, "LHandTrigger"),
        ...
        public override MixedRealityInteractionMapping[] DefaultRightHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(6, "Axis1D.SecondaryHandTrigger Press", AxisType.Digital, DeviceInputType.Trigger, "RHandTrigger"),
