...
namespace XRTK.Oculus.Providers.Controllers
{
    ...
    public abstract class BaseOculusController : BaseController
    {
        ...
        /// <inheritdoc />
        protected BaseOculusController(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerProfile controllerProfile, OculusApi.Controller controllerType = OculusApi.Controller.None, OculusApi.Node nodeType = OculusApi.Node.None)
